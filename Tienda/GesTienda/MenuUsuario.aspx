<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuUsuario.aspx.cs" Inherits="_Default" %>
    ...
    <div id="cuerpo">
       ...
       <div id="menu">
           <asp:Menu ID="Menu1" runat="server" BackColor="#B5C7DE" 
               ...
               <Items>
                   <asp:MenuItem Text="Inicio" Value="Inicio" NavigateUrl="~/MenuUsuario.aspx"></asp:MenuItem>
                   ...
                   <asp:MenuItem Selectable="False" Text="Compras" Value="Compras"></asp:MenuItem>
               </Items>
       ...
       <div id="contenido">
            <div id="contenidotitulo">Menú de usuario del sitio web</div>
            <br />
